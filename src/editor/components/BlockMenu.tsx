...
export function BlockMenu({
  ...
  return (
    <div
      ref={menuRef}
      className={`fixed z-[100] min-w-[200px] max-w-[240px] bg-popover backdrop-blur-sm border border-border rounded-xl shadow-elev-2 p-1.5 transition-[opacity,transform] duration-150 ${
        isVisible
