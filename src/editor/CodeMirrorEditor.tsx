...
const createEditorTheme = (fontSize: number) =>
  EditorView.theme({
    "&": {
      ...
      height: "100%",
      "--lumina-line-pad-left": "24px",
      "--lumina-line-pad-right": "16px",
      "--lumina-block-inline-size":
        "calc(100% - var(--lumina-line-pad-left) - var(--lumina-line-pad-right))",
    ...
    ".cm-math-block, .mermaid-container, .cm-image-widget, .cm-table-editor, .cm-table-widget":
      {
        ...
        width: "var(--lumina-block-inline-size)",
    ...
    ".markdown-block-shell": {
      ...
      boxSizing: "border-box",
      width: "var(--lumina-block-inline-size)",
      margin: "0 var(--lumina-line-pad-right) 0 var(--lumina-line-pad-left)",
...
function buildBlockWidgetAtomicRanges(state: EditorState): DecorationSet {
  ...
  // Tables are intentionally NOT registered here. Leaving them non-atomic keeps
  // cross-boundary text selection continuous: the same selection visual can run
  // from normal prose into rendered table content and back out again.
