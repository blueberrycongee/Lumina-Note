    ...
    >
      ...
      {open && (
        <div
          ref={menuRef}
          className={clsx(
            "absolute mt-1 w-44 rounded-ui-md border border-border bg-popover shadow-elev-2 py-1 z-50",
        ...
        >
          {SUPPORTED_LOCALES.map((loc) => (
            <button
              ...
              className={clsx(
                "w-full px-3 py-2 text-left text-ui-control hover:bg-accent transition-colors flex items-center justify-between",
