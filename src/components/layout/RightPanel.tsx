...
function BacklinksView() {
  ...
  if (!currentFile) {
    return (
      <div className="flex-1 flex flex-col items-center justify-center text-muted-foreground text-ui-control p-4">
        ...
        {backlinks.map((backlink, idx) => (
          ...
          >
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="text-ui-control font-medium truncate group-hover:text-primary">
                {backlink.name}
              </span>
              <ArrowUpRight
                size={12}
        ...
        {allTags.map((tagInfo) => (
          <div key={tagInfo.tag}>
            ...
            >
              ...
              <span className="text-ui-control flex-1">{tagInfo.tag}</span>
              ...
              <div className="bg-muted/30 border-l-2 border-primary/30 ml-4">
                {tagInfo.files.map((filePath) => (
                  <button
                    ...
                    className="w-full text-left px-3 py-1.5 hover:bg-accent transition-colors flex items-center gap-2 text-ui-control"
                  >
  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden">
      ...
      <div className="h-10 px-2 border-b border-border/50 flex items-center justify-between">
        <span className="text-ui-caption text-muted-foreground flex items-center gap-1">
          <List size={12} />
        ...
        {headings.map((heading) => {
          ...
          return (
            <button
              ...
              className="w-full text-left px-3 py-1.5 text-ui-control hover:bg-accent transition-colors flex items-center gap-2 group"
