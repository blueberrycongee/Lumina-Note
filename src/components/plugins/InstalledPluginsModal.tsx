...
export function InstalledPluginsModal({ isOpen, onClose }: InstalledPluginsModalProps) {
  ...
  const modal = (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      <div className="absolute inset-0 bg-black/30 animate-spotlight-overlay" onClick={onClose} aria-hidden="true" />

      <div className="relative w-[860px] max-h-[85vh] rounded-xl shadow-elev-3 overflow-hidden border border-border bg-popover animate-spotlight-in">
