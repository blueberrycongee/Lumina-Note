  ...
  return (
    <div className="h-full flex flex-col bg-background ui-app-bg">
      ...
      >
        ...
        <div className="relative flex-shrink-0 h-full z-20 before:absolute before:inset-x-0 before:top-0 before:h-11 before:border-b before:border-border before:pointer-events-none">
          <ResizeHandle
            direction="left"
