...
export default {
  ...
  editor: {
    ...
    slashMenu: {
      ...
      commands: {
        ...
        aiExpand: "AI 擴寫目前區塊",
        aiExpandDesc: "依原風格補充細節",
        aiExpandPrompt: "請擴寫目前區塊，補充必要細節與上下文，保持原有風格。",
        aiSummarize: "AI 總結目前區塊",
        aiSummarizeDesc: "提煉重點並產生簡短總結",
        aiSummarizePrompt: "請總結目前區塊，輸出精煉重點（Markdown 清單）。",
        heading1: "一級標題",
        heading1Desc: "大標題",
        heading2: "二級標題",
        heading2Desc: "章節標題",
  ...
  aiSettings: {
    ...
    contextWindow: "上下文視窗",
    contextWindowHint: "留空使用預設 32,000。只影響 OpenAI 相容通配模型的執行時限制。",
    maxOutputTokens: "最大輸出 Token",
    maxOutputTokensHint: "留空使用預設 4,096。推理模型需要給正文預留足夠輸出空間。",
    thinkingMode: "思考模式",
    thinkingModeThinking: "深度思考",
    thinkingModeInstant: "極速回應",
    thinkingModeHint:
    ...
    modelPicker: {
      ...
      contextContinues: "會繼續沿用目前對話上下文；為相容目標模型，部分歷史細節可能會被壓縮。",
    },
    temperature: "溫度 (Temperature)",
    temperatureLock: {
      title: "由模型鎖定",
