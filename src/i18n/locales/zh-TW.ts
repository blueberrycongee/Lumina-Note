...
export default {
  ...
  settingsModal: {
    ...
    background: "背景",
    backgroundNone: "無背景",
    backgroundImage: "本機圖片",
    chooseBackgroundImage: "選擇背景圖片",
    clearBackgroundImage: "移除圖片",
    resetBackground: "重設背景",
    backgroundOpacity: "背景強度",
    backgroundBlur: "模糊",
    backgroundDim: "遮罩",
    backgroundPresetPaper: "紙感",
    backgroundPresetMist: "薄霧",
    backgroundPresetSakura: "櫻色",
    backgroundPresetDusk: "暮色",
    editor: "編輯器",
