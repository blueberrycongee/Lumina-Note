...
export default {
  ...
  overview: {
    ...
    openClawDesc:
      "Lumina 正在操作 OpenClaw 的同一批檔案。目前識別到的產物檔案數：{count}。",
  ...
  profilePreview: {
    ...
    recentEmpty:
      "暫無公開筆記。請在筆記 frontmatter 中設定 visibility: public。",
    tagsEmpty: "沒有可展示的標籤。",
  },
  ...
  plugins: {
    ...
    title: "插件",
    intro:
      "Lumina 會優先從預設插件目錄（安裝位置旁）載入插件，並相容工作區 .lumina/plugins、使用者插件目錄與內建資源。",
  ...
  settingsModal: {
    ...
    themes: {
      ...
      cyberpunk: {
        name: "賽博龐克",
        description: "霓虹撞色：紫黑背景 + 螢光粉 + 青色高亮",
      },
      dracula: {
        name: "吸血鬼",
        description: "經典配色：冷灰背景 + 紫色 + 綠色 + 橙色混搭",
      },
      solarized: {
        name: "日蝕",
        description: "護眼高對比：暖米色背景 + 藍/橙/紅/綠 組合",
      },
      gruvbox: {
        name: "復古",
        description: "暖調懷舊：大地色背景 + 紅綠藍黃撞色",
      },
    },
    ...
    openClawTitle: "OpenClaw 工作區",
    openClawDesc:
      "把一個外部 OpenClaw 工作區掛到目前 Lumina 工作區，並明確標示這是一套共享真實檔案而不是匯入副本。",
    openClawEnabled: "啟用整合",
    openClawDisabledDesc:
      "OpenClaw 整合目前已關閉。重新啟用前，Lumina 會把此工作區當作一般資料夾處理。",
    openClawReleaseFlagDesc:
      "目前的 release flag 已關閉 OpenClaw 整合。要在這個 build 啟用它，請設定 VITE_ENABLE_OPENCLAW_WORKSPACE=1。",
    openClawNoWorkspace:
      "請先開啟一個本地工作區，再檢查它是否為 OpenClaw 工作區。",
    ...
    openClawMountedWorkspaceHint:
      "把外部 OpenClaw 工作區路徑掛到目前的 Lumina 工作區上。",
    openClawPathRequiredTitle: "尚未選擇 OpenClaw 工作區",
    openClawPathRequiredDesc:
      "先選擇一個外部 OpenClaw 工作區路徑，再進行重新檢測或附著。",
    ...
    openClawBoundaryHint:
      "你在 Lumina 中的修改會直接寫回 OpenClaw 正在使用的同一批檔案。這是附著工作區，不是匯入副本。",
