...
export default {
  ...
  editor: {
    ...
    slashMenu: {
      ...
      commands: {
        ...
        aiExpand: "AI 扩写当前块",
        aiExpandDesc: "在原风格上补充细节",
        aiExpandPrompt: "请扩写当前块，补充必要细节与上下文，保持原有风格。",
        aiSummarize: "AI 总结当前块",
        aiSummarizeDesc: "提炼要点并生成简短总结",
        aiSummarizePrompt: "请总结当前块，输出精炼要点（Markdown 列表）。",
        heading1: "一级标题",
        heading1Desc: "大标题",
        heading2: "二级标题",
        heading2Desc: "章节标题",
  ...
  aiSettings: {
    ...
    contextWindow: "上下文窗口",
    contextWindowHint: "留空使用默认 32,000。只影响 OpenAI 兼容通配模型的运行时限制。",
    maxOutputTokens: "最大输出 Token",
    maxOutputTokensHint: "留空使用默认 4,096。推理模型需要给正文预留足够输出空间。",
    thinkingMode: "思考模式",
    thinkingModeThinking: "深度思考",
    thinkingModeInstant: "极速响应",
    thinkingModeHint:
    ...
    modelPicker: {
      ...
      contextContinues: "会继续沿用当前对话上下文；为兼容目标模型，部分历史细节可能会被压缩。",
    },
    temperature: "温度 (Temperature)",
    temperatureLock: {
      title: "由模型锁定",
