...
export default {
  ...
  aiSettings: {
    ...
    complexTaskModelDesc: 'For complex planning, orchestrated agent runs, and heavier reasoning tasks.',
    ...
    complexTaskExamples: 'Complex tasks - long-context analysis, multi-step planning, and orchestrated agent tasks',
