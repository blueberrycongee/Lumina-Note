...
export default {
  ...
  sidebar: {
    ...
    openClawCronPluginUnavailable:
      "OpenClaw plugin command not available. Is the plugin enabled?",
  ...
  overview: {
    ...
    openClawDesc:
      "Lumina is using the same OpenClaw files. {count} artifact files detected.",
  ...
  settingsModal: {
    ...
    openClawTitle: "OpenClaw Workspace",
    openClawDesc:
      "Attach an external OpenClaw workspace so Lumina and OpenClaw work on the same files.",
    openClawEnabled: "Enable integration",
    openClawDisabledDesc:
      "OpenClaw integration is currently disabled. Lumina will treat the workspace as a normal folder until you re-enable it.",
    openClawReleaseFlagDesc:
      "OpenClaw integration is disabled by the current release flag. Set VITE_ENABLE_OPENCLAW_WORKSPACE=1 to turn the feature on for this build.",
    openClawNoWorkspace:
      "Open a local workspace first, then check whether it is an OpenClaw workspace.",
    ...
    openClawMountedWorkspaceHint:
      "Choose the external OpenClaw workspace path to attach to this Lumina workspace.",
    openClawPathRequiredTitle: "No OpenClaw workspace selected",
    openClawPathRequiredDesc:
      "Choose an external OpenClaw workspace path before rescanning or attaching.",
    ...
    openClawBoundaryHint:
      "Changes you make in Lumina update the same files OpenClaw uses. This is a live attachment, not an imported copy.",
  ...
  videoNote: {
    ...
    pasteVideoUrl:
      "Paste Bilibili video link, e.g. https://www.bilibili.com/video/BV...",
