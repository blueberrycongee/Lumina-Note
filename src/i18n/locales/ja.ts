...
export default {
  ...
  settingsModal: {
    ...
    background: "背景",
    backgroundNone: "なし",
    backgroundImage: "ローカル画像",
    chooseBackgroundImage: "背景画像を選択",
    clearBackgroundImage: "画像を削除",
    resetBackground: "背景をリセット",
    backgroundOpacity: "背景の強さ",
    backgroundBlur: "ぼかし",
    backgroundDim: "オーバーレイ",
    backgroundPresetPaper: "ペーパー",
    backgroundPresetMist: "ミスト",
    backgroundPresetSakura: "桜色",
    backgroundPresetDusk: "夕暮れ",
    editor: "エディター",
