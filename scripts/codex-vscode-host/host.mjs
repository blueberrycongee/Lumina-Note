...
function themeVariablesCss(mode) {
  const light = {
    ...
    "--vscode-editorGroup-dropBackground": "rgba(9, 105, 218, 0.18)",
    "--vscode-editorGroup-dropIntoPromptBackground": "#f6f8fa",
    "--vscode-editorGroup-dropIntoPromptForeground": "#1f2328",
    ...
    "--vscode-activityBar-activeBorder": "#0969da",
    ...
    "--vscode-inputOption-activeForeground": "#1f2328",
    "--vscode-inputOption-activeBackground": "#ddf4ff",
    "--vscode-inputOption-hoverBackground": "#f6f8fa",
    "--vscode-inputValidation-infoBackground": "#ddf4ff",
    "--vscode-inputValidation-infoBorder": "#0969da",
    ...
    "--vscode-checkbox-selectBackground": "#ddf4ff",
    "--vscode-checkbox-selectBorder": "#0969da",
    "--vscode-radio-activeForeground": "#0969da",
    "--vscode-menubar-selectionBackground": "#eaeef2",
    ...
    "--vscode-chat-requestBackground": "#ffffff",
    "--vscode-chat-requestBorder": "#d0d7de",
    "--vscode-chat-avatarBackground": "#f6f8fa",
    "--vscode-chat-avatarForeground": "#57606a",
    "--vscode-chat-slashCommandBackground": "#ddf4ff",
    "--vscode-chat-slashCommandForeground": "#0969da",
    ...
    "--vscode-terminal-ansiWhite": "#f6f8fa",
  ...
  const dark = {
    ...
    "--vscode-editorGroup-dropBackground": "rgba(0, 122, 204, 0.25)",
    ...
    "--vscode-inputOption-activeBackground": "#04395e",
    ...
    "--vscode-checkbox-selectBackground": "#04395e",
    "--vscode-checkbox-selectBorder": "#0078d4",
    "--vscode-radio-activeForeground": "#0078d4",
    "--vscode-menubar-selectionBackground": "#2a2d2e",
    ...
    "--vscode-chat-requestBackground": "#252526",
    "--vscode-chat-requestBorder": "#454545",
    "--vscode-chat-avatarBackground": "#2a2d2e",
    "--vscode-chat-avatarForeground": "#cccccc",
    "--vscode-chat-slashCommandBackground": "#04395e",
    "--vscode-chat-slashCommandForeground": "#4daafc",
