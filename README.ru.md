...
- Режим: `Agent` (встроенное расширение VS Code в боковой панели)
- Поддержка нескольких провайдеров: OpenAI / Anthropic (Claude) / DeepSeek / Gemini / Moonshot / Groq / OpenRouter / Ollama
- Простая настройка моделей по назначению: `Main Model`
...
3. Настройте провайдера модели и API key в AI-панели, а при необходимости задайте модели `Main` в Dynamic Routing.
