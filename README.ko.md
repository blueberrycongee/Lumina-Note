...
- **지식 작업 흐름 중심**: Markdown 편집, WikiLinks, 그래프 뷰, AI 에이전트가 하나의 시스템으로 이어집니다.
- **실제로 작업하는 AI**: `Agent` 모드가 실제 편집, 계획, 자동화 작업을 지원합니다.
...
- 프레임워크: Electron 41 (Chromium + Node.js in the main process)
